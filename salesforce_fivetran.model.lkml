...
###################### TEST EXPLORES (FOR TESTING FIELDS) ######################

# NOTE: Relationships in joins are not confirmed

explore: test_account {
  view_name: account
}

explore: test_campaign {
  view_name: campaign
}

explore: test_contact {
  view_name: contact
}
...
explore: test_opportunity {
  view_name: opportunity

  # included to test opportunity_stage.sort_order
  join: opportunity_stage {
    sql_on: ${opportunity_stage.api_name} = ${opportunity.stage_name} ;;
    relationship: one_to_one
  }
...
explore: test_opportunity_history {
  view_name: opportunity_history
}

explore: test_opportunity_stage {
  view_name: opportunity_stage
}
